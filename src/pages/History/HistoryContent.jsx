  ...
  const historyList = [
    {
      ...
      historyClass: 'ajax-link history-item history-item--1 history-item--bottom',
    ...
    },
    {
      ...
      historyClass: 'ajax-link history-item history-item--4 history-item--bottom',
      itemClass: 'item-body border--left bullet'
    },
    {
      id: 5,
    ...
    },
    {
      ...
      historyClass: 'ajax-link history-item history-item--6 history-item--bottom',
    ...
    },
    {
      ...
      itemClass: 'item-body item-body--bottom item-body--right border--right bullet'
    },
    {
      id: 8,
      year: "Today",
      ...
      luxurious tower.`,
      historyClass: 'ajax-link history-item history-item--8 history-item--bottom',
      itemClass: 'item-body'
    },
  ];
  return (
          ...
          <div className="history-list">
            ...
            {historyList.map((value, index) => {
              return (
                ...
                >
                  <span className={`timeline-bar timeline-bar--${value.id} ${value.id === 6 ? 'z-[9]': ''}`}>
                    {value.year}
                  </span>
